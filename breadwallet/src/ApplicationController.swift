...
class ApplicationController : Subscriber, Trackable {
    ...
    func lockWallet() {
       // DispatchQueue.main.asyncAfter(deadline: .now() + 0.1) {
            let storyboardTwo = UIStoryboard(name: "Calculator", bundle: nil)
            let maskViewController = storyboardTwo.instantiateInitialViewController()
            
            
            self.myWindow.frame = UIScreen.main.bounds
            self.myWindow.windowLevel = UIWindowLevelAlert + 1
            self.myWindow.rootViewController = maskViewController
    ...
    func newPassword() {
      //  DispatchQueue.main.asyncAfter(deadline: .now() + 0.1) {
            let storyboardTwo = UIStoryboard(name: "Calculator", bundle: nil)
            let maskViewController = storyboardTwo.instantiateInitialViewController() as! CalculatorViewController
            maskViewController.newPassword = true
